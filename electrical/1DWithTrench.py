...
.. math::
    ...
    \int_{-z_h}^{\delta}  dz \left[ c_{DL} \frac{\partial \psi}{\partial t} \Theta \left( z \right) =
...
.. math::
    ...
    \int_{-z_h}^{\delta}  dz  \left[\frac{\partial c_{\text{cu}}}{\partial t} A \left( z \right)  =
...
.. math::
    ...
    \int_{-z_h}^{\delta}  dz \left[\frac{\partial c_{\theta}}{\partial t} A \left( z \right) =
...
.. math::
    ...
    \int_{-z_h}^{\delta}  dz \left[\frac{\partial \theta}{\partial t} \Theta \left( z \right) =
...
\frac{A_T}{A_F} \right) + \delta(z + z_h) \frac{A_T}{A_F}`. The
...
:math:`z=-z_h` at the bottom of the trench.  The current density is
given by,
...
.. math::
     ...
     \psi = \frac{\delta}{z_{\text{ref}}} \eta \;\; & \text{at $t = 0$ forcing $\xi=\eta$ initially} \\
...
.. math::
     ...
     \psi_{\text{ref}} = \psi\left(0\right) \left(1 - \frac{z_{\text{ref}}}{\delta}\right)
...
def feature1D(delta=150e-6,
    ...
    totalSteps = 200
    dt=.5e-7
    viewers = (Viewer(potential), Viewer(cupric), Viewer(suppressor), Viewer(theta))
    ...
    for step in range(totalSteps):
        ...
        for sweep in range(5):
            ...
            # print 'potentialRef',potentialRef
